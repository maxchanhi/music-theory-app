...
from question import generate_question, correct_ans,question_elements
def duration_cal_main():
    ...
    if 'question' not in st.session_state:
        ...
        st.session_state['question'] = (small_dur, question_dur, question_dotted, dotted_time)
        st.session_state['correct'] = correct_ans(small_dur, question_dur, dotted_time)
        st.session_state['pressed_cd']=False
    small_dur, question_dur, question_dotted, dotted_time = st.session_state['question']
